...
public class HTML_Parser {
    ...
    public static void main(String args[]) throws IOException {
        ...
        Document doc= Jsoup.parse(input,"UTF-8");
         ...
         int no_of_propeties =3;
         hp.property = new String[no_of_propeties];
         int i=0;
...
//        System.out.println(Xsoup.compile("/html/body/table/tbody/tr[3]/td/table/tbody/tr[2]/td[2]/table/tbody/tr[3]/td/font/a").evaluate(doc).getElements());
//        System.out.println(Xsoup.compile("/html/body/table/tbody/tr[3]/td/table/tbody/tr[2]/td[2]/table/tbody/tr[4]/td/font/a").evaluate(doc).getElements());
//        System.out.println(Xsoup.compile("/html/body/table/tbody/tr[3]/td/table/tbody/tr[1]/td[1]/table/tbody/tr[8]/td[2]/font/strong").evaluate(doc).getElements());
//        System.out.println(Xsoup.compile("//html/body/table/tbody/tr[8]/td[2]/table/tbody/tr/td/table/tbody/tr[2]/td/font[3]/strong[1]").evaluate(doc).getElements());
//        System.out.println(Xsoup.compile("/html/body/table/tbody/tr[8]/td[2]/table/tbody/tr/td/table/tbody/tr[2]/td/font[3]/strong[2]").evaluate(doc).getElements());
